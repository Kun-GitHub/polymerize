...
public class XLSFile {
	...
	private String percentFmt = "0.00%"; // 金额显示格式

	/**
	 * 添加一个XLS表格
	 * 
	 * @param xlsSheet
	 *            XLS表格对象,请参考{@link XLSSheet}
	 */
	 ...
	 * 
	 * @param dateFmt
	 *            格式,如"yyyy-MM-dd HH:mm","MM月dd日"等
	 */
	 ...
	 *            格式,如"0.00%","#0.##%"等
	 */
	public void setPercnetFmt(String percentFmt) {
		if (null != percentFmt && !"".equals(percentFmt)) {
			this.percentFmt = percentFmt;
		}
	}
