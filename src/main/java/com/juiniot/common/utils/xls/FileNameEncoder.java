...
public class FileNameEncoder {
	 ...
	 */
	public static final String encode(String fileName, String userAgent) {
		if (fileName == null) {
			return "";
		}
	...
	protected static final String encodeURLEncoder(String safeFileName) {
		try {
	...
	protected static final String encodeBase64(String safeFileName) {
		try {
	...
	protected static final String encoedeRFC2231(String safeFileName) {
		try {
			String result = "Content-Disposition: attachment; filename*=UTF-8''" + URLEncoder.encode(safeFileName, "UTF8");
			return result;
		} catch (UnsupportedEncodingException e) {
			return safeFileName;
		}
	...
	protected static final String encodedISO(String safeFileName) {
		try {
			String result = "Content-Disposition: attachment; filename=" + new String(safeFileName.getBytes("UTF-8"), "ISO8859-1");
			return result;
		} catch (UnsupportedEncodingException e) {
			return safeFileName;
		}
	 ...
	 * @return 替换后的文件名
	 */
	protected static final String getSafeFileName(String fileName) {
		// / \ : * ? " < > |
	...
	public static void main(String[] args) {
		System.out.println(encode("中山.xls", "Mozilla/5.0 (iPhone; CPU iPhone OS 6_1_2 like Mac OS X) AppleWebKit/536.26 (KHTML, like Gecko) Version/6.0 Mobile/10B146 Safari/8536.25"));
	}
